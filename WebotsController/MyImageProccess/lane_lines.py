...
def pipeline(image, center_margin = 50):
    ...
    warped, M, M_inv = perspective_transform(gray_image,region_of_interest_vertices)
    ...
    if lines is None:
        return left_weight,right_weight,warped,0
    ...
    return left_weight,right_weight,warped,len(lines)